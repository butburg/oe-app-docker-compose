<textarea
    class="@error('comment', 'form_{{ $image->id }}') is-invalid @enderror w-full resize-none overflow-hidden rounded border p-2 text-sm text-title-bg"
