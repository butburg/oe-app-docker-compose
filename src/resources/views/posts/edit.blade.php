                ...
                <div class="p-6 text-c-text">
                    ...
                    <form class="mt-6 space-y-6" method="post"
                        ...
                        <div>
                            ...
                            @isset($post->image)
                                <x-input-label for="image_file" value="Your Current Image" />
                                <div class="my-2">
                                    @include('components.image_or_placeholder', [
                                        'image' => $post->image,
                                        'size_type' => 'l',
                                        'alt_title' => 'Your uploaded image',
                                        'style' => '',
                                    ])
                                </div>
                            @endisset
                        ...
                        <div>
                            ...
                            <x-text-input class="mt-1 block w-full" id="title" name="title" type="text"
                                :value="$post->title ?? old('title')" required autofocus maxlength="120" />
                        ...
                        <div class="mt-4">
                            <span class="inline-flex">
                                @include('components.checkbox', [
                                    'id' => 'is_sensitive',
                                    'name' => 'is_sensitive',
                                    'checked' => $post->is_sensitive ?? false,
                                ...
                                <div>
                                    ...
                                    <ul class="mt-1.5 list-inside list-disc">
                                        <ul class="list-inside list-disc">
                                            <li>Your <span class="font-medium">title</span>
                                            ...
                                            <li><span class="font-medium">Important:</span>
                                                Only images with <strong>no
                                                    copyright
                                                    restrictions</strong> are
                                                allowed.</li>
                                            <li><span class="font-medium">Protected
