...
<x-app-layout>
    ...
    <div class="py-12 text-content-text">
                    ...
                    <table class="w-full table-auto border-collapse text-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b p-4 pb-3 pl-8 pt-0 text-left font-medium 400">Image</th>
                                <th class="border-b p-4 pb-3 pl-8 pt-0 text-left font-medium 400">Details
                                </th>
                                <th class="border-b p-4 pb-3 pl-8 pt-0 text-left font-medium 400">Action</th>
                            </tr>
                        </thead>
                        <tbody class="text-gray-100">
                            ...
                            @forelse ($draftPosts as $post)
                                <tr>
                                    <td
                                        class="border-b border-slate-100 py-4  dark:border-slate-700 dark:400">
                                        <!-- Post Image -->
                                    ...
                                    <td
                                        class="border-b border-slate-100 p-4 pl-8  dark:border-slate-700 dark:400">
                            ...
                            @empty
                                ...
                                <tr>
                                    <td class="border-b border-slate-100 p-4 pl-8  dark:border-slate-700 dark:400"
                                        colspan="2">
                        ...
                        <tbody class="text-gray-100">
                            ...
                            @forelse ($publishedPosts as $post)
                                <tr>
                                    ...
                                    <td
                                        class="items-center justify-center border-b border-slate-100 p-4 pl-8  dark:border-slate-700 dark:400">
                                        <!-- Post content -->
                                        <span>
                                            {{ $post->title }}
                                        </span>
