    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl py-2 sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white/80 p-6 shadow-xl sm:rounded-lg">
                ...
                <div class="my-2">
                    <img src="{{ asset('storage/files/images/impressum-contact.png') }}" alt=" Information" width="130">
                </div>

                <x-header2>Kontakt</x-header2>
                <div class="my-2">
                    <img src="{{ asset('storage/files/images/impressum-mail.png') }}" alt="Mail Contact Information"
                        width="155">
                </div>

                <p>Quelle: <a class="font-medium text-blue-600 underline hover:no-underline dark:text-blue-500"
        ...
        <div class="mx-auto max-w-7xl py-2 sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white/80 p-6 shadow-xl sm:rounded-lg">
                <p><a class="underline hover:no-underline" href="#privacy-policy">(English version below)</a></p>
                <x-header2>Datenschutz&shy;erkl&auml;rung</x-header2>
                <h2 class="my-2 text-xl font-semibold">1. Datenschutz auf einen Blick</h2>
                <h3 class="my-2 text-lg font-semibold">Allgemeine Hinweise</h3>
                ...
                <h4 class="my-2 text-base font-semibold">Wer ist verantwortlich f&uuml;r die Datenerfassung auf
                    dieser Website?</h4>
                ...
                <h4 class="my-2 text-base font-semibold">Wie erfassen wir Ihre Daten?</h4>
                ...
                <h4 class="my-2 text-base font-semibold">Wof&uuml;r nutzen wir Ihre Daten?</h4>
                <p>Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu
                    ...
                    werden.</p>
                <h4 class="my-2 text-base font-semibold">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
                ...
                <p>Hierzu sowie zu weiteren Fragen zum Thema Datenschutz k&ouml;nnen Sie sich jederzeit an uns
                    wenden.</p>
                <h2 class="my-2 text-xl font-semibold">2. Hosting</h2>
                <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
                <h3 class="my-2 text-lg font-semibold">Externes Hosting</h3>
                ...
                <p>TrafficPlex GmbH<br />
                    ...
                    28217 Bremen, Deutschland</p>
                <h4 class="my-2 text-base font-semibold">Auftragsverarbeitung</h4>
                <p>Wir haben einen Vertrag &uuml;ber Auftragsverarbeitung (AVV) zur Nutzung des oben genannten
                ...
                <h2 class="my-2 text-xl font-semibold">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
                <h3 class="my-2 text-lg font-semibold">Datenschutz</h3>
                ...
                <h3 class="my-2 text-lg font-semibold">Hinweis zur verantwortlichen Stelle</h3>
                <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p>
                <div class="my-2">
                    <img src="{{ asset('storage/files/images/impressum-contact.png') }}" alt=" Information"
                        width="130">
                </div>
                Kontakt:
                <div class="my-2">
                    <img src="{{ asset('storage/files/images/impressum-mail.png') }}" alt=" Information" width="155">
                </div>
                ...
                <h3 class="my-2 text-lg font-semibold">Speicherdauer</h3>
                ...
                <h3 class="my-2 text-lg font-semibold">Allgemeine Hinweise zu den Rechtsgrundlagen der
                ...
                <h3 class="my-2 text-lg font-semibold">Empfänger von personenbezogenen Daten</h3>
                ...
                <h3 class="my-2 text-lg font-semibold">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
                <p>Viele Datenverarbeitungsvorg&auml;nge sind nur mit Ihrer ausdr&uuml;cklichen Einwilligung
                    ...
                    unber&uuml;hrt.</p>
                <h3 class="my-2 text-lg font-semibold">Widerspruchsrecht gegen die Datenerhebung in besonderen
                    F&auml;llen sowie gegen Direktwerbung
                    (Art. 21 DSGVO)</h3>
                ...
                <p>WERDEN IHRE PERSONENBEZOGENEN DATEN VERARBEITET, UM DIREKTWERBUNG ZU BETREIBEN, SO HABEN SIE DAS
                    ...
                    ABS. 2 DSGVO).</p>
                <h3 class="my-2 text-lg font-semibold">Beschwerde&shy;recht bei der zust&auml;ndigen
                ...
                <p>Im Falle von Verst&ouml;&szlig;en gegen die DSGVO steht den Betroffenen ein Beschwerderecht bei
                    ...
                    Rechtsbehelfe.</p>
                <h3 class="my-2 text-lg font-semibold">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
                <p>Sie haben das Recht, Daten, die wir auf Grundlage Ihrer Einwilligung oder in Erf&uuml;llung eines
                    ...
                    ist.</p>
                <h3 class="my-2 text-lg font-semibold">Auskunft, Berichtigung und L&ouml;schung</h3>
                ...
                <h3 class="my-2 text-lg font-semibold">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
                ...
                <h3 class="my-2 text-lg font-semibold">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
                ...
                <h2 class="my-2 text-xl font-semibold">4. Datenerfassung auf dieser Website</h2>
                <h3 class="my-2 text-lg font-semibold">Cookies</h3>
                ...
                <p>Welche Cookies und Dienste auf dieser Website eingesetzt werden, k&ouml;nnen Sie dieser
                    Datenschutzerkl&auml;rung entnehmen.</p>
                <h3 class="my-2 text-lg font-semibold">Server-Log-Dateien</h3>
                ...
                <h2 class="my-2 text-xl font-semibold">Registrierung, Anmeldung und Nutzerkonto</h2>
                ...
                <p>Im Rahmen der Inanspruchnahme unserer Registrierungs- und Anmeldefunktionen sowie der Nutzung des
                    ...
                    Dritte erfolgt grundsätzlich nicht, es sei denn, es besteht eine gesetzliche Verpflichtung
                    hierzu.</p>
                ...
                <p class="my-2"><strong>Weitere Hinweise:</strong></p>
                <ul class="list-disc pb-3 pl-6">
                    <li>Registrierung mit Pseudonymen: Nutzer dürfen statt Klarnamen Pseudonyme als
                        Nutzernamen verwenden.</li>
                    <li>Löschung von Daten nach Kündigung: Wenn Nutzer ihr Nutzerkonto gekündigt
                        haben, werden deren Daten im Hinblick auf das Nutzerkonto, vorbehaltlich einer gesetzlichen
                        Erlaubnis, Pflicht oder Einwilligung der Nutzer, gelöscht.</li>
                    <li>Keine Aufbewahrungspflicht für Daten: Es obliegt den Nutzern, ihre Daten
                        bei erfolgter Kündigung vor dem Vertragsende zu sichern. Wir sind berechtigt, sämtliche
                        während der Vertragsdauer gespeicherte Daten des Nutzers unwiederbringlich zu löschen.</li>
                </ul>
                <h3 class="my-2 text-lg font-semibold">Kommentar&shy;funktion auf dieser Website</h3>
                <p>F&uuml;r die Kommentarfunktion auf dieser Seite werden neben Ihrem Kommentar auch Angaben zum
                    Zeitpunkt der Erstellung des Kommentars, Ihre E-Mail-Adresse und der von Ihnen gew&auml;hlte
                    Nutzername gespeichert.</p>
                <h4 class="my-2 text-base font-semibold">Speicherdauer der Kommentare</h4>
                <p>Die Kommentare und die damit verbundenen Daten werden gespeichert und verbleiben auf dieser
                    Website, bis der kommentierte Inhalt vollst&auml;ndig gel&ouml;scht wurde oder die Kommentare
                    aus rechtlichen Gr&uuml;nden gel&ouml;scht werden m&uuml;ssen (z.&nbsp;B. beleidigende
                    Kommentare).</p>
                <h4 class="my-2 text-base font-semibold">Rechtsgrundlage</h4>
                ...
                <h2 class="my-2 text-xl font-semibold">5. Newsletter</h2>
                <h3 class="my-2 text-lg font-semibold">Newsletter&shy;daten</h3>
                ...
                <p>Die von Ihnen zum Zwecke des Newsletter-Bezugs bei uns hinterlegten Daten werden von uns bis zu
                    ...
                    l&ouml;schen oder zu sperren.</p>
                ...
                <p>Nach Ihrer Austragung aus der Newsletterverteilerliste wird Ihre E-Mail-Adresse bei uns bzw. dem
                    ...
                    Speicherung in der Blacklist ist zeitlich nicht befristet. <strong>Sie k&ouml;nnen der
        ...
        <div class="mx-auto max-w-7xl py-2 sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white/80 p-6 shadow-xl sm:rounded-lg" id="privacy-policy">
                <x-header2>Privacy policy</x-header2>
                <p>1. data protection at a glance</p>
                <p>
                    General information</p>
                <p>
                <p>The following information provides a simple overview of what happens to your personal data when
                    you
                    visit this website. Personal data is any data that can be used to identify you personally. For
                    detailed information on the subject of data protection, please refer to our data protection
                    declaration listed below this text.</p>

                <p>Data collection on this website</p>
                <p>
                    Who is responsible for data collection on this website?</p>
                <p>
                    Data processing on this website is carried out by the website operator. You can find their
                    contact
                    details in the "Information on the controller" section of this privacy policy.</p>
                ...
                <p>Other data is collected automatically or with your consent by our IT systems when you visit the
                ...
                <p>
                    ...
                    may
                    be used to analyse your user behaviour.</p>
                ...
                <p>
                    ...
                    consent at any time for the future. You also have the right to request the restriction of the
                    processing of your personal data under certain circumstances. You also have the right to lodge a
                    complaint with the competent supervisory authority.</p>

                <p>You can contact us at any time regarding this and other questions on the subject of data
                    protection.</p>
                ...
                <p>
                    ...
                    servers of the hoster(s). This may include IP addresses, contact requests, meta and
                    communication
                    data, contract data, contact details, names, website accesses and other data generated via a
                    website.</p>

                <p>External hosting is carried out for the purpose of fulfilling the contract with our potential and
                    existing customers (Art. 6 para. 1 lit. b GDPR) and in the interest of a secure, fast and
                    efficient
                    ...
                    of
                    Art. 6 para. 1 lit. a GDPR and § 25 para. 1 TDDDG, insofar as the consent includes the storage
                    of
                    cookies or access to information in the user's end device (e.g. device fingerprinting) within
                    the
                    meaning of the TDDDG. Consent can be revoked at any time.</p>

                <p>Our hoster(s) will only process your data to the extent necessary to fulfil its performance
                    obligations and follow our instructions with regard to this data.</p>
                ...
                <p>
                    ...
                    This is a contract prescribed by data protection law, which ensures that the personal data of
                    our
                    website visitors is only processed in accordance with our instructions and in compliance with
                    the
                    GDPR.</p>

                <p>3 General notes and mandatory information</p>
                <p>
                    Data protection</p>
                <p>
                ...
                <p>When you use this website, various personal data is collected. Personal data is data that can be
                    used to identify you personally. This privacy policy explains what data we collect and what we
                    use
                    it for. It also explains how and for what purpose this is done.</p>

                <p>We would like to point out that data transmission over the Internet (e.g. when communicating by
                    email) may be subject to security vulnerabilities. Complete protection of data against access by
                    third parties is not possible.</p>

                <p>Note on the responsible body</p>
                <p>
                    The party responsible for data processing on this website is</p>
                <div class="my-2">
                    <img src="{{ asset('storage/files/images/impressum-contact.png') }}" alt=" Information"
                        width="130">
                </div>
                ...
                <p>The controller is the natural or legal person who alone or jointly with others determines the
                    purposes and means of the processing of personal data (e.g. names, email addresses, etc.).</p>
                ...
                <p>
                    ...
                    justified request for deletion or revoke your consent to data processing, your data will be
                    deleted
                    unless we have other legally permissible reasons for storing your personal data (e.g. retention
                    periods under tax or commercial law); in the latter case, deletion will take place after these
                    reasons no longer apply.</p>

                <p>General information on the legal basis for data processing on this website</p>
                <p>
                    If you have consented to data processing, we process your personal data on the basis of Art. 6
                    para.
                    1 lit. a GDPR or Art. 9 para. 2 lit. a GDPR, insofar as special categories of data are processed
                    in
                    accordance with Art. 9 para. 1 GDPR. In the event of express consent to the transfer of personal
                    data to third countries, data processing is also carried out on the basis of Art. 49 para. 1
                    lit. a
                    GDPR. If you have consented to the storage of cookies or access to information in your end
                    device
                    (e.g. via device fingerprinting), the data processing is also carried out on the basis of
                    Section 25
                    (1) TDDDG. Consent can be revoked at any time. If your data is required for the fulfilment of a
                    contract or for the implementation of pre-contractual measures, we process your data on the
                    basis of
                    Art. 6 para. 1 lit. b GDPR. Furthermore, we process your data if this is necessary to fulfil a
                    legal
                    obligation on the basis of Art. 6 para. 1 lit. c GDPR. Data processing may also be carried out
                    on
                    the basis of our legitimate interest in accordance with Art. 6 para. 1 lit. f GDPR. Information
                    on
                    the relevant legal bases in each individual case is provided in the following paragraphs of this
                    privacy policy.</p>

                <p>Recipients of personal data</p>
                <p>
                    As part of our business activities, we work together with various external organisations. In
                    some
                    cases, it is also necessary to transfer personal data to these external bodies. We only pass on
                    personal data to external bodies if this is necessary for the fulfilment of a contract, if we
                    are
                    legally obliged to do so (e.g. passing on data to tax authorities), if we have a legitimate
                    interest
                    in the transfer in accordance with Art. 6 para. 1 lit. f GDPR or if another legal basis permits
                    the
                    transfer of data. When using processors, we only pass on our customers' personal data on the
                    basis
                    of a valid contract for order processing. In the case of joint processing, a joint processing
                    agreement is concluded.</p>

                <p>Revocation of your consent to data processing</p>
                <p>
                    Many data processing operations are only possible with your express consent. You can revoke any
                ...
                <p>
                    ...
                    TO
                    THE PROCESSING OF YOUR PERSONAL DATA AT ANY TIME ON GROUNDS RELATING TO YOUR PARTICULAR
                    SITUATION;
                    THIS ALSO APPLIES TO PROFILING BASED ON THESE PROVISIONS. THE RESPECTIVE LEGAL BASIS ON WHICH
                    PROCESSING IS BASED CAN BE FOUND IN THIS PRIVACY POLICY. IF YOU OBJECT, WE WILL NO LONGER
                    PROCESS
                    YOUR PERSONAL DATA CONCERNED UNLESS WE CAN DEMONSTRATE COMPELLING LEGITIMATE GROUNDS FOR THE
                    PROCESSING WHICH OVERRIDE YOUR INTERESTS, RIGHTS AND FREEDOMS OR THE PROCESSING SERVES THE
                    ESTABLISHMENT, EXERCISE OR DEFENCE OF LEGAL CLAIMS (OBJECTION PURSUANT TO ART. 21 PARA. 1 GDPR).
                </p>

                <p>IF YOUR PERSONAL DATA ARE PROCESSED FOR THE PURPOSE OF DIRECT MARKETING, YOU HAVE THE RIGHT TO
                    ...
                    YOU
                    OBJECT, YOUR PERSONAL DATA WILL SUBSEQUENTLY NO LONGER BE USED FOR THE PURPOSE OF DIRECT
                    MARKETING
                    (OBJECTION PURSUANT TO ART. 21 PARA. 2 GDPR).</p>
                ...
                <p>
                    ...
                    work
                    or place of the alleged violation. The right to lodge a complaint is without prejudice to any
                    other
                ...
                <p>
                    ...
                    fulfilment of a contract handed over to you or to a third party in a commonly used,
                    machine-readable
                    format. If you request the direct transfer of the data to another controller, this will only
                    take
                    place if it is technically feasible.</p>

                <p>Information, rectification and erasure</p>
                <p>
                    ...
                    data
                    processing and, if necessary, a right to correction or deletion of this data. You can contact us
                    at
                    any time regarding this and other questions on the subject of personal data.</p>
                ...
                <p>
                    ...
                    If you dispute the accuracy of your personal data stored by us, we generally need time to verify
                    this. For the duration of the review, you have the right to request that the processing of your
                    personal data be restricted.</p>
                <p>
                    If the processing of your personal data was/is unlawful, you can request the restriction of data
                    processing instead of erasure.</p>
                <p>
                    If we no longer need your personal data, but you need it for the exercise, defence or assertion
                    of
                    legal claims, you have the right to request the restriction of the processing of your personal
                    data
                    instead of its erasure.</p>
                <p>
                    ...
                    prevail,
                    you have the right to request the restriction of the processing of your personal data.</p>
                <p>
                    If you have restricted the processing of your personal data, this data - apart from its storage
                    -
                    may only be processed with your consent or for the establishment, exercise or defence of legal
                    claims or for the protection of the rights of another natural or legal person or for reasons of
                    important public interest of the European Union or of a Member State.</p>

                <p>SSL or TLS encryption</p>
                <p>
                    This site uses SSL or TLS encryption for security reasons and to protect the transmission of
                    confidential content, such as orders or enquiries that you send to us as the site operator. You
                    can
                    recognise an encrypted connection by the fact that the address line of the browser changes from
                    "http://" to "https://" and by the lock symbol in your browser line.</p>

                <p>If SSL or TLS encryption is activated, the data you transmit to us cannot be read by third
                    parties.</p>
                ...
                <p>
                    Cookies</p>
                <p>
                    Our Internet pages use so-called "cookies". Cookies are small data packets and do not cause any
                    damage to your end device. They are stored on your device either temporarily for the duration of
                    a
                    session (session cookies) or permanently (permanent cookies). Session cookies are automatically
                    deleted at the end of your visit. Permanent cookies remain stored on your end device until you
                    delete them yourself or they are automatically deleted by your web browser.</p>

                <p>Cookies may originate from us (first-party cookies) or from third-party companies (so-called
                    third-party cookies). Third-party cookies enable the integration of certain services from
                    third-party companies within websites (e.g. cookies for processing payment services).</p>

                <p>Cookies have various functions. Many cookies are technically necessary, as certain website
                    functions
                    would not work without them (e.g. the shopping basket function or the display of videos). Other
                    cookies can be used to analyse user behaviour or for advertising purposes.</p>

                <p>Cookies that are required to carry out the electronic communication process, to provide certain
                    functions that you have requested (e.g. for the shopping basket function) or to optimise the
                    website
                    (e.g. cookies to measure the web audience) (necessary cookies) are stored on the basis of Art. 6
                    para. 1 lit. f GDPR, unless another legal basis is specified. The website operator has a
                    legitimate
                    interest in the storage of necessary cookies for the technically error-free and optimised
                    provision
                    of its services. If consent to the storage of cookies and comparable recognition technologies
                    has
                    been requested, the processing is carried out exclusively on the basis of this consent (Art. 6
                    para.
                    1 lit. a GDPR and § 25 para. 1 TDDDG); the consent can be revoked at any time.</p>

                <p>You can set your browser so that you are informed about the setting of cookies and only allow
                    cookies in individual cases, exclude the acceptance of cookies for certain cases or in general
                    and
                    activate the automatic deletion of cookies when closing the browser. If cookies are deactivated,
                    the
                    functionality of this website may be restricted.</p>
                ...
                <p>
                    Browser type and browser version</p>
                <p>
                    Operating system used</p>
                <p>
                    Referrer URL</p>
                <p>
                    Host name of the accessing computer</p>
                <p>
                    Time of the server enquiry</p>
                <p>
                    IP address</p>
                <p>
                    This data is not merged with other data sources.</p>

                <p>This data is collected on the basis of Art. 6 para. 1 lit. f GDPR. The website operator has a
                    legitimate interest in the technically error-free presentation and optimisation of its website -
                    the
                    server log files must be recorded for this purpose.</p>

                <p>Registration, login and user account</p>
                <p>
                    Users can create a user account. As part of the registration process, users are provided with
                    the
                    required mandatory information and processed for the purpose of providing the user account on
                    the
                    basis of contractual fulfilment of obligations. The processed data includes in particular the
                    login
                    information (user name, password and an e-mail address).</p>

                <p>As part of the use of our registration and login functions and the use of the user account, we
                    store
                    the IP address and the time of the respective user action. This data is stored on the basis of
                    our
                    legitimate interests and those of the user in protection against misuse and other unauthorised
                    use.
                    This data is not passed on to third parties unless there is a legal obligation to do so.</p>

                <p>Users can be informed by email about processes that are relevant to their user account, such as
                    technical changes.</p>

                <p>Further information:</p>
                <p>

                    Registration with pseudonyms: Users may use pseudonyms as usernames instead of real names.</p>
                <p>
                    Deletion of data after cancellation: If users have cancelled their user account, their data
                    relating
                    to the user account will be deleted, subject to legal permission, obligation or user consent.
                </p>
                <p>
                    No obligation to retain data: It is the responsibility of users to back up their data before the
                    end
                    of the contract in the event of cancellation. We are authorised to irretrievably delete all user
                    data stored during the term of the contract.</p>
                <p>
                    Comment function on this website</p>
                <p>
                    For the comment function on this site, in addition to your comment, details of the time the
                    comment
                    was created, your e-mail address and the user name you have chosen are also stored.</p>

                <p>Storage duration of the comments</p>
                <p>
                    The comments and the associated data are stored and remain on this website until the content
                    commented on has been completely deleted or the comments have to be deleted for legal reasons
                    (e.g.
                    offensive comments).</p>

                <p>Legal basis</p>
                <p>
                    Comments are stored on the basis of your consent (Art. 6 para. 1 lit. a GDPR). You can revoke
                    your
                    consent at any time. All you need to do is send us an informal email. The legality of the data
                ...
                <p>
                    ...
                    address provided and that you agree to receive the newsletter. No further data is collected, or
                    only
                    on a voluntary basis. We use this data exclusively for sending the requested information and do
                    not
                    pass it on to third parties.</p>

                <p>The data entered in the newsletter registration form is processed exclusively on the basis of
                    your
                    consent (Art. 6 para. 1 lit. a GDPR). You can revoke your consent to the storage of the data,
                    the
                    e-mail address and its use for sending the newsletter at any time, for example via the
                    "unsubscribe"
                    link in the newsletter. The legality of the data processing operations that have already taken
                    place
                    remains unaffected by the cancellation.</p>

                <p>The data you provide us with for the purpose of subscribing to the newsletter will be stored by
                    us
                    or the newsletter service provider until you unsubscribe from the newsletter and deleted from
                    the
                    newsletter distribution list after you unsubscribe from the newsletter or after the purpose has
                    ceased to exist. We reserve the right to delete or block e-mail addresses from our newsletter
                    distribution list at our own discretion within the scope of our legitimate interest in
                    accordance
                    with Art. 6 para. 1 lit. f GDPR.</p>

                <p>Data stored by us for other purposes remains unaffected by this.</p>

                <p>After you unsubscribe from the newsletter distribution list, your email address may be stored by
                    us
                    or the newsletter service provider in a blacklist if this is necessary to prevent future
                    mailings.
                    The data from the blacklist will only be used for this purpose and will not be merged with other
                    data. This serves both your interest and our interest in complying with the legal requirements
                    when
                    sending newsletters (legitimate interest within the meaning of Art. 6 para. 1 lit. f GDPR).
                    Storage
                    in the blacklist is not limited in time.</p>
                <p>You can object to the storage if your interests outweigh
                    our legitimate interest.</p>
                <p>Source: <a class="font-medium text-blue-600 underline hover:no-underline dark:text-blue-500"
                        href="https://www.e-recht24.de">e-recht24.de</a></p>
            </div>
        </div>
    </div>
